  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
      <NavLink to="/" onClick={()=>setOpen(false)}>
        <img className="h-15 w-45" src={assets.logo2} alt="LOGO" />
      </NavLink>
      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        {/* cart option mobile lo kanipinchataniki */}
      ...
      { open && (
      <div
        className={`${open ? "flex" : "hidden"} absolute top-[60px] left-0 w-full bg-green-100 shadow-md py-4 flex-col  items-center gap-2 px-5 text-sm md:hidden`}
      >
