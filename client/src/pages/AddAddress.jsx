...
const InputField =({type,placeholder,name,handleChange,address})=>(
    <input type={type} className='w-full px-2 py-2.5 border border-gray-500/30 rounded outline-none text-gray-500 focus:border-primary transition'
